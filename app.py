...
<title>My Wishlist - MyStore</title>
<style>
*{box-sizing:border-box;margin:0;padding:0}
...
<body>
<nav class="nav">
  <a href="/" class="nav-logo">My<span>Store</span>&bull;</a>
...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>{a['title']} – MyStore Blog</title>
<link href="https://fonts.googleapis.com/css2?family=Clash+Display:wght@400;500;600;700&family=Syne:wght@400;600;700;800&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;1,400&display=swap" rel="stylesheet">
<style>
...
<body>
<div class="topbar">
  <a href="/"><span class="brand"><span class="brand-my">My</span><span class="brand-store">Store</span></span></a>
